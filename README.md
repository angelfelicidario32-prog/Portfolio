...
**• ESP32 Microcontroller** - The system uses an ESP32, which serves as the main controller for processing sensor data and managing the alarm system.

**• Sensor-Based Detection** - Sensors are used to detect motion, vibration, or bag opening attempts. Once triggered, the device responds automatically.

**• Loud Alarm Notification** - The alarm produces a loud sound to warn the owner and attract attention during theft attempts.

**• Wireless Connectivity** - Because of the ESP32’s built-in Wi-Fi and Bluetooth features, the device can connect to smartphones or other devices for monitoring.

**• Compact and Portable Design** - The system is lightweight and can easily fit inside or attach to a bag.

**• Rechargeable Power Supply** - The device can operate using rechargeable batteries for convenient everyday use.

**• Real-Time Alerts** - The system can send instant notifications or signals when suspicious activity is detected.

**• Easy to Use** - Users can quickly activate or deactivate the alarm through a switch or mobile connection.
